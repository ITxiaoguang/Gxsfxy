...
public class PointsListAdapter extends RecyclerView.Adapter<PointsListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        String time = TimeUtil.decode(hashMap.get("pl_time"));
        String temp = time + " : " + hashMap.get("pl_content") + "<font color='#FF0000'> " + hashMap.get("pl_type") + " " + hashMap.get("pl_points") + " </font> ";
