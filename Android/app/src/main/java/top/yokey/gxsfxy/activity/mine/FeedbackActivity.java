...
import top.yokey.gxsfxy.adapter.FeedbackListAdapter;
...
public class FeedbackActivity extends AppCompatActivity {
        ...
        if (res == RESULT_OK) {
            switch (req) {
                ...
                case MyApplication.CODE_CHOOSE_PHOTO_CROP:
                    imagePath = FileUtil.createJpgByBitmap("feedback", mApplication.mBitmap);
    ...
    private void initData() {
        ...
        mAdapter = new FeedbackListAdapter(mApplication, mArrayList);
    ...
    private void initEven() {
        ...
        cameraImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                imageFile = new File(FileUtil.getImagePath() + "feedback.jpg");
    ...
    private void getFeedback() {
        ...
        UserAjaxParams ajaxParams = new UserAjaxParams(MainActivity.mApplication, "userMessage", "feedbackRecord");

        MainActivity.mApplication.mFinalHttp.post(MainActivity.mApplication.apiUrlString + "c=userMessage&a=feedbackRecord", ajaxParams, new AjaxCallBack<Object>() {
            @Override
    ...
    private void sendFeedback(final String type, final String content) {
        ...
        UserAjaxParams ajaxParams = new UserAjaxParams(mApplication, "userMessage", "feedbackAdd");
        ajaxParams.put("type", type);
        ajaxParams.put("content", content);

        mApplication.mFinalHttp.post(mApplication.apiUrlString + "c=userMessage&a=feedbackAdd", ajaxParams, new AjaxCallBack<Object>() {
            @Override
            public void onSuccess(Object o) {
                super.onSuccess(o);
