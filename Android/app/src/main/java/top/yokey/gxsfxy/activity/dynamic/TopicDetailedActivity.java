...
public class TopicDetailedActivity extends AppCompatActivity {
    ...
    private void initEven() {
        ...
        shareImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ToastUtil.show(mActivity, "话题不支持转发");
            }
        });
        ...
        mApplication.mFinalHttp.post(mApplication.apiUrlString + "c=base&a=dynamicDetailed", ajaxParams, new AjaxCallBack<Object>() {
            ...
            public void onSuccess(Object o) {
                ...
                if (!data.contains("dynamic_id")) {
                    ToastUtil.show(mActivity, "话题不存在或已删除");
                    returnActivity();
                } else {
                    ...
                    try {
                        ...
                        //内容
                        String name = "# <font color='#115FB2'>" + mHashMap.get("dynamic_title") + "</font> #";
                        ...
                        String info = jsonObject.getString("nick_name") + " 发表于 "
                                + TimeUtil.decode(mHashMap.get("dynamic_time"));
