...
public class MapListAdapter extends RecyclerView.Adapter<MapListAdapter.ViewHolder> {
    ...
    public MapListAdapter(ArrayList<HashMap<String, String>> arrayList) {
        ...
        holder.mTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (itemClickListener != null) {
                    itemClickListener.onItemClick(hashMap.get("name"), hashMap.get("address"));
                }
            }
        });
    ...
    public ViewHolder onCreateViewHolder(ViewGroup group, int viewType) {
        View view = LayoutInflater.from(group.getContext()).inflate(R.layout.item_list_map, group, false);
