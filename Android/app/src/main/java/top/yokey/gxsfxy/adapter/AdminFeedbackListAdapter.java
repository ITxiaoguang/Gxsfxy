...
import top.yokey.gxsfxy.activity.admin.AdminFeedbackDetailedActivity;
import top.yokey.gxsfxy.utility.TextUtil;
import top.yokey.gxsfxy.utility.TimeUtil;

public class AdminFeedbackListAdapter extends RecyclerView.Adapter<AdminFeedbackListAdapter.ViewHolder> {

    private Activity mActivity;
    private MyApplication mApplication;
    private ArrayList<HashMap<String, String>> mArrayList;

    public AdminFeedbackListAdapter(MyApplication application, Activity activity, ArrayList<HashMap<String, String>> arrayList) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mRelativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(mActivity, AdminFeedbackDetailedActivity.class);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup group, int viewType) {
        View view = LayoutInflater.from(group.getContext()).inflate(R.layout.item_list_admin_feedbook, group, false);
