...
public class MineFollowListAdapter extends BaseAdapter implements SectionIndexer {
    ...
    public MineFollowListAdapter(MyApplication application, Activity activity, List<FriendBean> list) {
        this.mList = list;
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        ...
        holder.followTextView.setText("取消关注");
                                ...
                                mApplication.mFinalHttp.post(mApplication.apiUrlString + "c=userFollow&a=followCancel", ajaxParams, new AjaxCallBack<Object>() {
                                    ...
                                    public void onSuccess(Object o) {
                                        ...
                                        if (mApplication.getJsonSuccess(o.toString())) {
                                            ...
                                            if (mList.isEmpty()) {
                                                MineFollowActivity.tipsTextView.setText("暂时没有关注的人");
                                                MineFollowActivity.tipsTextView.setVisibility(View.VISIBLE);
                                            }
                                        } else {
