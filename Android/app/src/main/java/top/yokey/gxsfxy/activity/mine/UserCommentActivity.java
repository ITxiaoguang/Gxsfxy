...
import top.yokey.gxsfxy.adapter.UserCommentListAdapter;
...
public class UserCommentActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        if (user_id.equals(mApplication.userHashMap.get("user_id"))) {
            titleTextView.setText("我的评论");
        } else {
            titleTextView.setText("他的评论");
        }

        mArrayList = new ArrayList<>();
        mAdapter = new UserCommentListAdapter(mApplication, mActivity, mArrayList);
    ...
    private void initEven() {
        ...
        mAdapter.setOnItemDelClickListener(new UserCommentListAdapter.onItemDelClickListener() {
            @Override
            public void onItemDelClick() {
                if (mArrayList.isEmpty()) {
                    tipsTextView.setText("还没评论过什么");
    ...
    private void getJson() {
        ...
        UserAjaxParams ajaxParams = new UserAjaxParams(mApplication, "userComment", "praiseComment");
        ajaxParams.put("page", pageInt + "");
        ajaxParams.put("user_id", user_id);

        mApplication.mFinalHttp.post(mApplication.apiUrlString + "c=userComment&a=commentList", ajaxParams, new AjaxCallBack<Object>() {
            @Override
