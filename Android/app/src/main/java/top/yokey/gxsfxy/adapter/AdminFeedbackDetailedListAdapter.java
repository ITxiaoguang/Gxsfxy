...
public class AdminFeedbackDetailedListAdapter extends RecyclerView.Adapter<AdminFeedbackDetailedListAdapter.ViewHolder> {

    private MyApplication mApplication;
    private ArrayList<HashMap<String, String>> mArrayList;

    public AdminFeedbackDetailedListAdapter(MyApplication application, ArrayList<HashMap<String, String>> arrayList) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (hashMap.get("message_uid").equals("-1")) {
            //系统回复的
            holder.myAvatarImageView.setVisibility(View.VISIBLE);
            holder.myAvatarImageView.setImageResource(R.mipmap.ic_launcher);
