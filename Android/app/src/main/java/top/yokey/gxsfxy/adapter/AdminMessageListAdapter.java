...
public class AdminMessageListAdapter extends RecyclerView.Adapter<AdminMessageListAdapter.ViewHolder> {

    private MyApplication mApplication;
    private ArrayList<HashMap<String, String>> mArrayList;

    public AdminMessageListAdapter(MyApplication application, ArrayList<HashMap<String, String>> arrayList) {
