...
public class AdminMessageActivity extends AppCompatActivity {
        ...
        if (res == RESULT_OK) {
            switch (req) {
                ...
                case MyApplication.CODE_CHOOSE_PHOTO_CROP:
                    imagePath = FileUtil.createJpgByBitmap("admin_message", mApplication.mBitmap);
    ...
    private void initData() {
        ...
        mAdapter = new AdminMessageListAdapter(mApplication, mArrayList);
    ...
    private void initEven() {
        ...
        cameraImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                imageFile = new File(FileUtil.getImagePath() + "admin_message" + ".jpg");
    ...
    private void getAdminMessage() {
        ...
        UserAjaxParams ajaxParams = new UserAjaxParams(AdminMainActivity.mApplication, "adminMessage", "messageRecord");

        AdminMainActivity.mApplication.mFinalHttp.post(AdminMainActivity.mApplication.apiUrlString + "c=adminMessage&a=messageRecord", ajaxParams, new AjaxCallBack<Object>() {
            @Override
    ...
    private void getAdminMessageFailure() {
    ...
    private void sendAdminMessage(final String type, final String content) {
        ...
        UserAjaxParams ajaxParams = new UserAjaxParams(mApplication, "adminMessage", "messageAdd");
        ajaxParams.put("type", type);
        ajaxParams.put("content", content);

        mApplication.mFinalHttp.post(mApplication.apiUrlString + "c=adminMessage&a=messageAdd", ajaxParams, new AjaxCallBack<Object>() {
            @Override
            public void onSuccess(Object o) {
                super.onSuccess(o);
