...
import top.yokey.gxsfxy.adapter.FriendListAdapter;
...
public class FriendActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        pageInt = 1;
        keyword = "";
        titleTextView.setText("好友推荐");

        mArrayList = new ArrayList<>();
        mAdapter = new FriendListAdapter(mApplication, mActivity, mArrayList);
    ...
    private void getJson() {
        ...
        if (TextUtil.isEmpty(keyword)) {
            url = mApplication.apiUrlString + "c=userFriend&a=friendList";
            ajaxParams = new UserAjaxParams(mApplication, "userFriend", "friendList");
            ajaxParams.put("page", pageInt + "");
        } else {
            url = mApplication.apiUrlString + "c=userFriend&a=friendSearch";
            ajaxParams = new UserAjaxParams(mApplication, "userFriend", "friendSearch");
            ajaxParams.put("page", pageInt + "");
