...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        boyRadioButton = (RadioButton) findViewById(R.id.boyRadioButton);
        girlRadioButton = (RadioButton) findViewById(R.id.girlRadioButton);
    ...
    private void initEven() {
        ...
        boyRadioButton.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
        ...
        girlRadioButton.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b) {
                    gender = "女";
    ...
    private void reg() {
        ...
        BaseAjaxParams ajaxParams = new BaseAjaxParams(mApplication, "base", "registerMobile");
        ...
        mApplication.mFinalHttp.post(mApplication.apiUrlString + "c=base&a=registerMobile", ajaxParams, new AjaxCallBack<Object>() {
            @Override
