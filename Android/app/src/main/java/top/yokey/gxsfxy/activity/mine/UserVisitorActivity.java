...
import top.yokey.gxsfxy.adapter.UserVisitorListAdapter;
...
public class UserVisitorActivity extends AppCompatActivity {
    ...
    private UserVisitorListAdapter mAdapter;
    ...
    private void initData() {
        ...
        if (user_id.equals(mApplication.userHashMap.get("user_id"))) {
            titleTextView.setText("我的访客记录");
        } else {
            titleTextView.setText("他的访客记录");
        }

        mArrayList = new ArrayList<>();
        mAdapter = new UserVisitorListAdapter(mApplication, mActivity, mArrayList);
    ...
    private void getJson() {
        ...
        UserAjaxParams ajaxParams = new UserAjaxParams(mApplication, "userCenter", "userVisitor");
        ajaxParams.put("page", pageInt + "");
        ajaxParams.put("user_id", user_id);

        mApplication.mFinalHttp.post(mApplication.apiUrlString + "c=userCenter&a=userVisitor", ajaxParams, new AjaxCallBack<Object>() {
            @Override
