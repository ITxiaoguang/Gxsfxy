...
import top.yokey.gxsfxy.adapter.MineFollowListAdapter;
...
public class MineFollowActivity extends AppCompatActivity implements SectionIndexer {
    ...
    private MineFollowListAdapter mAdapter;
    ...
    private void initData() {
        ...
        if (user_id.equals(mApplication.userHashMap.get("user_id"))) {
            titleTextView.setText("我关注的");
        } else {
            titleTextView.setText("他关注的");
        }

        mList = new ArrayList<>();
        mAdapter = new MineFollowListAdapter(mApplication, mActivity, mList);
    ...
    private void getJson() {
        ...
        UserAjaxParams ajaxParams = new UserAjaxParams(mApplication, "userFollow", "mineFollow");
        ajaxParams.put("user_id", user_id);

        mApplication.mFinalHttp.post(mApplication.apiUrlString + "c=userFollow&a=mineFollow", ajaxParams, new AjaxCallBack<Object>() {
            @Override
